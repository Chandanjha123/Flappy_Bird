...
class Game:
    def __init__(self):
        ...
        self.score_text_rect=self.score_text.get_rect(center=(500,30))
        self.restart=self.font.render("Restart",True,(255,255,255))
        self.restart_rect=self.restart.get_rect(center=(300,700))
